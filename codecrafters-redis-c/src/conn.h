...
// read a token from the conneciton. Note that the redis protocol is using /r/n as delimiter
// hence we are using it to split a token.
// return a char*, receiver should release the buffer.
